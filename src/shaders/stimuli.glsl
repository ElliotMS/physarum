...
layout(rgba32f, binding = 1) uniform image2D stimuliMap;
...
void main()
{
    ...
    vec4 stimuliValue = imageLoad(stimuliMap, pixelPos);
    imageStore(trailMap, pixelPos, currentValue + stimuliValue * stimWeight);
}