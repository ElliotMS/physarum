...
#define DISPLAY_WIDTH  config::settings.GetInteger("PROGRAM", "DISPLAY_WIDTH", 1000)
#define DISPLAY_HEIGHT config::settings.GetInteger("PROGRAM", "DISPLAY_HEIGHT", 1000)
...
#define SPAWN_MODE     config::settings.GetInteger("AGENT", "SPAWN_MODE", 0)
#define KILL_CHANCE    config::settings.GetFloat("AGENT", "KILL_CHANCE", 0.0)
#define TEXTURE_WIDTH  config::settings.GetInteger("ENVIRONMENT", "TEXTURE_WIDTH", 1000)
#define TEXTURE_HEIGHT config::settings.GetInteger("ENVIRONMENT", "TEXTURE_HEIGHT", 1000)
#define DECAY_SPEED_R  config::settings.GetFloat("ENVIRONMENT", "DECAY_SPEED_R", 0.005)
#define DECAY_SPEED_G  config::settings.GetFloat("ENVIRONMENT", "DECAY_SPEED_G", 0.005)
#define DECAY_SPEED_B  config::settings.GetFloat("ENVIRONMENT", "DECAY_SPEED_B", 0.005)
...
#define STIM_RADIUS    config::settings.GetInteger("ENVIRONMENT", "STIM_RADIUS", 10)
