...
#define SENSOR_ANGLE   config::settings.GetInteger("AGENT",		  "SENSOR_ANGLE",	45) * (3.14159265359 / 180)
#define ROTATION_ANGLE config::settings.GetFloat  ("AGENT",		  "ROTATION_ANGLE",	45) * (3.14159265359 / 180)
